#!/usr/bin/env python3
"""
Incremental extract runner that appends/updates staging tables.

Usage examples:
  python scripts/run_extracts_incremental.py
  python scripts/run_extracts_incremental.py --only core
"""
...
EXTRACT_SCRIPTS = {
    "core": SCRIPT_DIR / "extract_incremental.py",
